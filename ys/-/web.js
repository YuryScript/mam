...
var $;
(function ($) {
    $mol_style_attach("ys/omc/omc.css", "\n\n[mol_check_box] {\n\tmin-width: 20px !important;\n\tmin-height: 20px !important;\n\twidth: 20px;\n\theight: 20px;\n}\n");
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $ys_omc_chunk.prototype, "chunkArray", null);
        __decorate([
            $mol_mem
        ], $ys_omc_chunk.prototype, "sub", null);
        $$.$ys_omc_chunk = $ys_omc_chunk;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$ys_theme_nes) = class $ys_theme_nes extends ($.$mol_plugin) {
		theme(){
			return "$ys_theme_nes";
		}
		attr(){
...
var $;
(function ($) {
    $mol_style_attach("ys/theme/nes/nes.css", ":root {\n\t--mol_theme_luma: 1;\n\t--mol_theme_image: none;\n\t--mol_theme_spirit: rgba(255,255,255,0.75); /* нет прямого аналога, но белый с прозрачностью */\n\t--mol_theme_back: #fff; /* основной фон */\n    --mol_theme_card: #fff; /* фон карточек */\n    --mol_theme_field: #fff; /* поля ввода */\n    --mol_theme_hover: #e7e7e7; /* hover кнопок */\n    --mol_theme_text: #212529; /* основной текст */\n    --mol_theme_shade: #adafbc; /* тень/шэйд */\n    --mol_theme_line: #212529; /* граница */\n    --mol_theme_focus: rgba(173,175,188,0.3); /* фокус */\n    --mol_theme_control: #212529; /* управляющие элементы */\n    --mol_theme_current: #209cee; /* активный/текущий */\n    --mol_theme_special: #92cc41; /* success/спец */\n\t--mol_gap_block: .75rem;\n\t--mol_gap_text: .5rem .75rem;\n\t--mol_gap_round: .25rem;\n\t--mol_gap_space: .25rem;\n\t--mol_gap_blur: .5rem;\n}\n");
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("ys/theme/nes/demo/demo.css", "[ys_theme_nes_demo_items] {\n\talign-items: start;\n\tmargin: 1rem;\n\tgap: 0.5rem;\n}");
})($ || ($ = {}));
...
;
	($.$ys_theme_win7) = class $ys_theme_win7 extends ($.$mol_plugin) {
		theme(){
			return "$ys_theme_win7";
		}
		attr(){
			return {"mol_theme": (this.theme())};
		}
...
var $;
(function ($) {
    $mol_style_attach("ys/theme/win7/win7.css", ":root {\n\t--mol_theme_luma: 1;\n\t--mol_theme_image: none;\n\t--mol_theme_spirit: hsl( 0deg, 0%, 100%, .75 );\n\t--mol_theme_back: oklch( 92% .01 var(--mol_theme_hue) );\n    --mol_theme_card: oklch( 99% .01 var(--mol_theme_hue) / .5 );\n    --mol_theme_field: oklch( 100% 0 var(--mol_theme_hue) / .5 );\n    --mol_theme_hover: oklch( 70% 0 var(--mol_theme_hue) / .1 );\n    --mol_theme_text: oklch( 20% 0 var(--mol_theme_hue) );\n    --mol_theme_shade: oklch( 60% 0 var(--mol_theme_hue) );\n    --mol_theme_line: oklch( 50% 0 var(--mol_theme_hue) / .25 );\n    --mol_theme_focus: oklch( 60% .2 calc( var(--mol_theme_hue) + 180deg ) );\n    --mol_theme_control: oklch( 40% .15 var(--mol_theme_hue) );\n    --mol_theme_current: oklch( 50% .2 calc( var(--mol_theme_hue) - var(--mol_theme_hue_spread) ) );\n    --mol_theme_special: oklch( 50% .2 calc( var(--mol_theme_hue) + var(--mol_theme_hue_spread) ) );\n\t--mol_gap_block: .75rem;\n\t--mol_gap_text: .5rem .75rem;\n\t--mol_gap_round: .25rem;\n\t--mol_gap_space: .25rem;\n\t--mol_gap_blur: .5rem;\n}\n");
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("ys/theme/win7/demo/demo.css", "[ys_theme_win7_demo_items] {\n\talign-items: start;\n\tmargin: 1rem;\n\tgap: 0.5rem;\n}");
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("ys/zoomable/zoomable.css", "[ys_zoomable] {\n\tposition: relative;\n\twidth: 800px;\n\theight: 800px;\n\toverflow: hidden;\n}\n\n[ys_zoomable_zoomComponent] {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\ttransition: 0s;\n\tuser-select: none;\n\tbackground-image:\n\t\trepeating-linear-gradient(to right, rgba(0, 0, 0, 0.5) 0, rgba(0, 0, 0, 0.5) 1px, transparent 1px, transparent 20px),\n\t\trepeating-linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0, rgba(0, 0, 0, 0.5) 1px, transparent 1px, transparent 20px);\n}\n\n[ys_zoomable_controls] {\n\tposition: absolute;\n\ttop: var(--mol_gap_space);\n\tright: var(--mol_gap_space); \n\tdisplay: flex;\n\tflex-flow: row nowrap;\n\tgap: var(--mol_gap_space);\n}\n");
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $ys_zoomable extends $.$ys_zoomable {
            position(next = [0, 0]) {
                return next;
            }
            size(next = [
            ...
            event_mouse_leave(event) {
                this.isDragging(false);
            }
        }
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "position", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "size", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "isDragging", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "dragStartPos", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "center", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "zoom", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "move_step", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "zoomLimits", null);
        __decorate([
            $mol_mem
        ], $ys_zoomable.prototype, "styleForZoomComponent", null);
        $$.$ys_zoomable = $ys_zoomable;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("ys/ys.css", "[ys_main_demo] {\n\twidth: 100vw;\n\theight: 100vh;\n\toverflow: auto;\n}\n\n");
})($ || ($ = {}));
